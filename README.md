...
> Football analytics, coach assistant, and Morocco World Cup 2030 fan platform ? built on computer vision, recommendation systems, and LLM integration.

## Documentation

| Document | Description |
|----------|-------------|
| [App Fields & Screens](docs/APP_FIELDS_AND_SCREENS.md) | All app fields, routes, themes, and screenshots (Part 1 Coach + Part 2 World Cup) |
| [Commit History](docs/COMMIT_HISTORY.md) | Human-readable git commit log |
| [Features](FEATURES.md) | Full feature overview and API reference |
